...
CONFIG = [
    ...
    },
    {
        'id': 4,
        'name': 'chain',
        'directory': 'Layer 4 - Chain',
        'required': True,
        'rarity_weights': [99875,125]
    },
    {
        'id': 5,
        'name': 'wear',
        'directory': 'Layer 5 - Wear',
        'required': True,
        'rarity_weights': None,
    },
    {
